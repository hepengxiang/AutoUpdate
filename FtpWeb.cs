...
namespace AutoUpdate
{
    ...
    public class FtpWeb
    {
        ...
        /// </summary>
        /// <param name="FtpServerIP">FTP连接地址</param>
        /// <param name="FtpServerSocket">FTP连接端口</param>
        /// <param name="FtpRemotePath">指定FTP连接成功后的当前目录, 如果不指定即默认为根目录</param>
        /// <param name="FtpUserID">用户名</param>
        /// <param name="FtpPassword">密码</param>
        public FtpWeb(string FtpServerIP, string FtpServerSocket, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
            ftpServerIP = FtpServerIP;
            ftpRemotePath = FtpRemotePath;
            ftpUserID = FtpUserID;
            ...
            {
                ftpURI = "ftp://" + ftpServerIP + ":" + FtpServerSocket + "/" + ftpRemotePath + "/";
            }
        ...
        public void Upload(string filename)
        {
            ...
            if (ftpUserID != string.Empty) reqFTP.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
            ...
            {
                throw new Exception("ftp上传错误:" + ex.Message);
            }
            finally
            {
                strm.Close();
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            {
                throw new Exception("ftp下载错误: " + ex.Message);
            }
            finally
            {
                ftpStream.Close();
        ...
        public void Delete(string fileName)
        {
            ...
            {
                throw new Exception("ftp删除文件[" + fileName + "]错误: " + ex.Message);
            }
        }
        ...
        public void RemoveDirectory(string folderName)
        {
            ...
            {
                throw new Exception("ftp删除文件夹[" + folderName + "]错误: " + ex.Message);
            }
        }
        ...
        public string[] GetFilesDetailList()
        {
            try
            {
                ...
                if (ftpUserID != string.Empty) ftp.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
            ...
            {
                throw new Exception("ftp获取当前目录错误: " + ex.Message);
            }
        }
        ...
        public string[] GetFileList(string mask)
        {
            ...
            {
                throw new Exception("ftp获取文件列表错误: " + ex.Message);
            }
        }
        ...
        public void MakeDir(string dirName)
        {
            ...
            {
                throw new Exception("ftp创建[" + dirName + "错误: " + ex.Message);
            }
        }
        ...
        public long GetFileSize(string filename)
        {
            ...
            {
                throw new Exception("ftp获取[" + filename + "]大小错误: " + ex.Message);
            }
            return fileSize;
        }
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            {
                throw new Exception("ftp重合名[" + currentFilename + "]错误: " + ex.Message);
            }
        }
        ...
        /// 删除订单目录
        /// </summary>
        /// <param name="ftpServerIP">主机地址</param>
        /// <param name="folderToDelete">用户名</param>
        /// <param name="ftpUserID">用户名</param>
        /// <param name="ftpPassword">密码</param>
